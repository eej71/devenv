...
(defconst spectral-flourescent-green "#D1FF19")
...
(let* ((spectral/orange       "#FF951B")
       (spectral/light-blue   "#82A6DF")
       (spectral/lightblue-2  "#00ffff") ;; This one is a keeper
       ...
       (spectral/background   "#000000")
       (spectral-background-00 "#000000")
       (spectral-background-01 "#080808")
       (spectral-background-02 "#101010")
       (spectral-background-03 "#181818")
       (spectral-background-04 "#202020")
       (spectral-background-05 "#282828")
       (spectral-background-06 "#303030")
       (spectral-background-07 "#383838")
       (spectral-background-08 "#404040")
       (spectral-background-09 "#484848")
       (spectral-background-10 "#505050")
       (spectral-background-11 "#585858")
       (spectral-background-12 "#606060")
       (spectral-background-13 "#686868")
       (spectral-background-14 "#707070")
       (spectral-background-15 "#787878")
       (spectral-background-16 "#808080")
       (spectral-background-17 "#888888")
       (spectral-background-18 "#909090")
       (spectral-background-19 "#989898")
       (spectral-background-20 "#A0A0A0")
       (spectral-background-21 "#A8A8A8")
       (spectral-background-22 "#B0B0B0")
       (spectral-background-23 "#B8B8B8")
       (spectral-background-24 "#C0C0C0")
       (spectral-background-25 "#C8C8C8")
       (spectral-background-26 "#D0D0D0")
       (spectral-background-27 "#D8D8D8")
       (spectral-background-28 "#E0E0E0")
       (spectral-background-29 "#E8E8E8")
       (spectral-background-30 "#F0F0F0")
       (spectral-background-31 "#F8F8F8")
       (spectral-background-32 "#FFFFFF")

       (spectral/foreground   "#FFFFFF")
       (spectral-foreground-00 "#FFFFFF")
       (spectral-foreground-01 "#F8F8F8")
       (spectral-foreground-02 "#F0F0F0")
       (spectral-foreground-03 "#E8E8E8")
       (spectral-foreground-04 "#E0E0E0")
       (spectral-foreground-05 "#D8D8D8")
       (spectral-foreground-06 "#D0D0D0")
       (spectral-foreground-07 "#C8C8C8")
       (spectral-foreground-08 "#C0C0C0")
       (spectral-foreground-09 "#B8B8B8")
       (spectral-foreground-10 "#B0B0B0")
       (spectral-foreground-11 "#A8A8A8")
       (spectral-foreground-12 "#A0A0A0")
       (spectral-foreground-13 "#989898")
       (spectral-foreground-14 "#909090")
       (spectral-foreground-15 "#888888")
       (spectral-foreground-16 "#808080")
       (spectral-foreground-17 "#787878")
       (spectral-foreground-18 "#707070")
       (spectral-foreground-19 "#686868")
       (spectral-foreground-20 "#606060")
       (spectral-foreground-21 "#585858")
       (spectral-foreground-22 "#505050")
       (spectral-foreground-23 "#484848")
       (spectral-foreground-24 "#404040")
       (spectral-foreground-25 "#383838")
       (spectral-foreground-26 "#303030")
       (spectral-foreground-27 "#282828")
       (spectral-foreground-28 "#202020")
       (spectral-foreground-29 "#181818")
       (spectral-foreground-30 "#101010")
       (spectral-foreground-31 "#080808")
       (spectral-foreground-32 "#000000")

       ;; Generated by https://huey.design/ - starting color r=255, 0, 0, hue=12, tints=12, scaling=intensity
       (color-palette-names '("red" "orange" "yellow" "chartreuse" "green" "springgreen" "cyan" "azure" "blue" "violet" "magenta" "rose")))

  ;; Let's make a list of names
  (defun eej/create-color-name (idx offset)
    (symbol-value (intern
                   (format "spectral-%s-%02d"
                           (nth (mod idx (length color-palette-names)) color-palette-names)
                           (+ (mod idx 5) offset)))))

  (defun eej/project-hash-value ()
    "Returns an integer that is a distinct value for where this project is located."
  ...
  (custom-theme-set-faces
   ...
   `(compilation-column-number ((t (:foreground ,spectral-yellow))))
   `(compilation-line-number ((t (:foreground "#870000"))))
   `(compilation-enter-directory-face ((t (:foreground ,spectral-green))))
   `(compilation-error ((t (:background ,spectral-red-08 :foreground "white" :bold t :italic t))))
   ...
   `(marginalia-file-priv-no ((t (:foreground ,spectral-springgreen-07))))
   `(marginalia-file-priv-dir ((t (:foreground ,spectral-springgreen-07))))
   `(marginalia-file-priv-link ((t (:foreground ,spectral-springgreen-07))))
   `(marginalia-file-priv-read ((t (:foreground ,spectral-springgreen-07))))
   `(marginalia-file-priv-write ((t (:foreground ,spectral-springgreen-07))))
   `(marginalia-file-priv-exec ((t (:foreground ,spectral-springgreen-07))))
   `(marginalia-file-priv-other ((t (:foreground ,spectral-springgreen-07))))
   `(marginalia-file-priv-rare ((t (:foreground ,spectral-springgreen-07))))
   ;;
...
;;;;; dired-async
   ...
   `(w3m-anchor ((t (:foreground ,spectral-yellow :underline t  :weight bold))))
   `(w3m-arrived-anchor ((t (:foreground ,spectral-yellow-2  :underline t :weight normal))))
   `(w3m-form ((t (:foreground ,spectral-red-1 :underline t))))
   `(w3m-header-line-location-title ((t (:foreground ,spectral-yellow :underline t :weight bold))))
