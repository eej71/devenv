...
(let* ((spectral/background   "#000000")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face       ((t (:foreground ,spectral/limegreen-1 :background "#080808" :italic t))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,spectral/limegreen-1 :background "#080808" :bold t))))
   ...
   `(compilation-error ((t (:background "#870000" :foreground "white" :weight bold))))
