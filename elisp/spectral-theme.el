...
(let* ((spectral/orange       "#FF951B")
       ...
       (spectral-red-01 "#ffe2e2")
       (spectral-red-02 "#ffc5c5")
       (spectral-red-03 "#ffa6a6")
       (spectral-red-04 "#ff8484")
       (spectral-red-05 "#ff5d5d")
       (spectral-red-06 "#ff1414")
       (spectral-red-07 "#dd0000")
       (spectral-red-08 "#b90000")
       (spectral-red-09 "#970000")
       (spectral-red-10 "#760000")
       (spectral-red-11 "#560000")
       (spectral-red-12 "#390000")

       (spectral-orange-01 "#ffe5c2")
       (spectral-orange-02 "#ffc98a")
       (spectral-orange-03 "#ffab57")
       (spectral-orange-04 "#f09335")
       (spectral-orange-05 "#dc7c1d")
       (spectral-orange-06 "#c5680c")
       (spectral-orange-07 "#ac5601")
       (spectral-orange-08 "#974100")
       (spectral-orange-09 "#812e00")
       (spectral-orange-10 "#681d00")
       (spectral-orange-11 "#4e1000")
       (spectral-orange-12 "#340700")

       (spectral-yellow-00  "#d7ff00")
       (spectral-yellow-00a "#FFEF00")
       (spectral-yellow-00b "#FFFF00")
       (spectral-yellow-01 "#eded9a")
       (spectral-yellow-02 "#d9d95f")
       (spectral-yellow-03 "#c4c439")
       (spectral-yellow-04 "#afaf1f")
       (spectral-yellow-05 "#9a9a0e")
       (spectral-yellow-06 "#868602")
       (spectral-yellow-07 "#727200")
       (spectral-yellow-08 "#5f5f00")
       (spectral-yellow-09 "#4c4c00")
       (spectral-yellow-10 "#3a3a00")
       (spectral-yellow-11 "#292900")
       (spectral-yellow-12 "#191900")

       (spectral-chartreuse-01 "#adff59")
       (spectral-chartreuse-02 "#8ceb2e")
       (spectral-chartreuse-03 "#76d517")
       (spectral-chartreuse-04 "#63be08")
       (spectral-chartreuse-05 "#53a800")
       (spectral-chartreuse-06 "#3d9300")
       (spectral-chartreuse-07 "#2c7e00")
       (spectral-chartreuse-08 "#1e6a00")
       (spectral-chartreuse-09 "#135500")
       (spectral-chartreuse-10 "#0b4200")
       ...
       (spectral-green-03 "#00dc00")
       (spectral-green-04 "#00c500")
       (spectral-green-05 "#00ad00")
       (spectral-green-06 "#009600")
       (spectral-green-07 "#008000")
       (spectral-green-08 "#006b00")
       (spectral-green-09 "#005600")
       (spectral-green-10 "#004200")
       (spectral-green-11 "#002f00")
       (spectral-green-12 "#001d00")

       (spectral-springgreen-01 "#8affc9")
       (spectral-springgreen-02 "#35f093")
       (spectral-springgreen-03 "#1bd97a")
       (spectral-springgreen-04 "#0bc266")
       (spectral-springgreen-05 "#00ab56")
       (spectral-springgreen-06 "#00953f")
       (spectral-springgreen-07 "#00802d")
       (spectral-springgreen-08 "#006a1e")
       (spectral-springgreen-09 "#005613")
       (spectral-springgreen-10 "#00420b")
       (spectral-springgreen-11 "#002f05")
       (spectral-springgreen-12 "#001d02")

       (spectral-cyan-01 "#b6f4f4")
       (spectral-cyan-02 "#7ae4e4")
       (spectral-cyan-03 "#4dd0d0")
       (spectral-cyan-04 "#2dbbbb")
       (spectral-cyan-05 "#17a5a5")
       (spectral-cyan-06 "#089090")
       (spectral-cyan-07 "#007b7b")
       (spectral-cyan-08 "#006666")
       (spectral-cyan-09 "#005252")
       (spectral-cyan-10 "#003f3f")
       (spectral-cyan-11 "#002d2d")
       (spectral-cyan-12 "#001c1c")

       (spectral-flourescent-green "#D1FF19")

       (spectral-azure-00 "#11FFEE") ;; Fluorescent Blue
       (spectral-azure-01 "#d2ecff")
       (spectral-azure-02 "#a8d9ff")
       (spectral-azure-03 "#80c4ff")
       (spectral-azure-04 "#5baeff")
       (spectral-azure-05 "#3c98f4")
       (spectral-azure-06 "#2382e1")
       (spectral-azure-07 "#0f6dcb")
       (spectral-azure-08 "#0259b0")
       (spectral-azure-09 "#00449b")
       (spectral-azure-10 "#003084")
       (spectral-azure-11 "#001e6a")
       (spectral-azure-12 "#000f4c")

       (spectral-blue-01 "#e7e7ff")
       (spectral-blue-02 "#cfcfff")
       (spectral-blue-03 "#b7b7ff")
       (spectral-blue-04 "#9f9fff")
       (spectral-blue-05 "#8787ff")
       (spectral-blue-06 "#6e6eff")
       (spectral-blue-07 "#5454ff")
       (spectral-blue-08 "#3333ff")
       (spectral-blue-09 "#0000f4")
       (spectral-blue-10 "#0000c0")
       (spectral-blue-11 "#00008f")
       (spectral-blue-12 "#000061")

       (spectral-violet-01 "#f3e3ff")
       (spectral-violet-02 "#e7c7ff")
       (spectral-violet-03 "#daabff")
       (spectral-violet-04 "#cc8fff")
       (spectral-violet-05 "#bc71ff")
       (spectral-violet-06 "#a953fe")
       (spectral-violet-07 "#9437f1")
       (spectral-violet-08 "#7c1ddc")
       (spectral-violet-09 "#6308be")
       (spectral-violet-10 "#48009e")
       (spectral-violet-11 "#2b007d")
       (spectral-violet-12 "#140058")

       (spectral-magenta-01 "#fbe1fb")
       (spectral-magenta-02 "#f6c2f6")
       (spectral-magenta-03 "#f0a4ef")
       (spectral-magenta-04 "#e885e7")
       (spectral-magenta-05 "#dc66db")
       (spectral-magenta-06 "#cd47cc")
       (spectral-magenta-07 "#b92ab8")
       (spectral-magenta-08 "#a0129f")
       (spectral-magenta-09 "#840283")
       (spectral-magenta-10 "#6b0058")
       (spectral-magenta-11 "#510036")
       (spectral-magenta-12 "#36001d")

       (spectral-rose-01 "#ffe0f2")
       (spectral-rose-02 "#ffc1e4")
       (spectral-rose-03 "#ffa0d5")
       (spectral-rose-04 "#ff7cc2")
       (spectral-rose-05 "#fe52a8")
       (spectral-rose-06 "#ec2f8e")
       (spectral-rose-07 "#d21473")
       (spectral-rose-08 "#b3035b")
       (spectral-rose-09 "#93003d")
       (spectral-rose-10 "#740024")
